...
C needed in tauola/fpik, tauola/bwigs, formf/form* , formf/curr :
        ...
        WRITE (IOUT,*) ' KORB: rho/rhop -> pi-pi0 mixing:'
        WRITE (IOUT,*) ' KORB: rho   =',PARM(1,9) ,PARM(2,9)
        WRITE (IOUT,*) ' KORB: rhop  =',PARM(1,15),PARM(2,15),PARM(3,15)
        WRITE (IOUT,*) ' KORB: K*/K*prime -> Kpi mixing:'
        WRITE (IOUT,*) ' KORB: kstp  =',PARM(1,16),PARM(2,16),PARM(3,16)
        WRITE (IOUT,*) ' KORB: a1/a1prime -> 3pi, KKpi mixing:'
        WRITE (IOUT,*) ' KORB: a1    =',PARM(1,10),PARM(2,10)
        WRITE (IOUT,*) ' KORB: a1prim=',PARM(1,17),PARM(2,17),PARM(3,17)
        WRITE (IOUT,*) ' KORB: K1A/K1B -> Kpipi mixing:'
        WRITE (IOUT,*) ' KORB: K1A   =',PARM(1,19),PARM(2,19),PARM(3,19)
        WRITE (IOUT,*) ' KORB: K1B   =',PARM(1,20),PARM(2,20),PARM(3,20)
        WRITE (IOUT,*) ' KORB: rho/rhop/rhopp -> 4pi mixing:'
        WRITE (IOUT,*) ' KORB: rho   =',PARM(1,9) ,PARM(2,9)
        WRITE (IOUT,*) ' KORB: rhopp =',PARM(1,21),PARM(2,21),PARM(3,21)
        WRITE (IOUT,*) ' KORB: rhoppp=',PARM(1,22),PARM(2,22),PARM(3,22)
...
CCC        IF (IPLIST(2,282).EQ.5) THEN
        ...
        WRITE (IOUT,*) ' KORB: 3PI-PI0 PARAMS:',(PARM(3,I),I=31,35)
        WRITE (IOUT,*) ' KORB: PI-3PI0 PARAMS:',(PARM(3,I),I=36,37)
